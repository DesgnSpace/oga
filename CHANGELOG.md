...
- An instruction you send a Claude worker while it works now reaches it straight away, instead of waiting for the current run to end. Other workers still pick it up the moment that run finishes.
