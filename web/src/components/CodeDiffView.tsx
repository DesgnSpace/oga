// The diff renderer and its highlighter, loaded only once a diff is shown.
...
export default function CodeDiffView({ patch, numbered = false, wrap = false }: CodeDiffProps) {
